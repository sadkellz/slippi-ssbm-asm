...
PROCESS_MODIFICATIONS:
  ...
  # PROCESS_GLASS_CANNON:
  #   rlwinm. r0, REG_FLAGS, 0, 31-SR_CARD_GLASSCANNON, 31-SR_CARD_GLASSCANNON
  #   beq PROCESS_ELEMENTS
  #   # increase glass cannon holders dmg, opp kb will be handled elsewhere
  #   GET_HB_BASE_DAMAGE REG_TEMP, REG_DATA
  #   mulli REG_TEMP, REG_TEMP, 3
  #   srwi REG_TEMP, REG_TEMP, 1          # divide by 2 (shift right 1) / dmg * 1.5
  #   SET_HB_BASE_DAMAGE REG_DATA, REG_TEMP
