...
.set TEXT_BACKGROUND_R, TEXT_STRETCH + 8
.set TEXT_BACKGROUND_G, TEXT_BACKGROUND_R + 1
.set TEXT_BACKGROUND_B, TEXT_BACKGROUND_G + 1
.set TEXT_BACKGROUND_A, TEXT_BACKGROUND_B + 1
.set TEXT_DEFAULT_COLOR, TEXT_BACKGROUND_A + 1
